...
(function (LevelType) {
    ...
    LevelType[LevelType["contextual"] = 2] = "contextual";
})(LevelType || (LevelType = {}));
...
async function checkerHelper3Star(level) {
    try {
        ...
        return jestError.message;
    }
    return "";
}
async function checkerHelperCustom(level, scriptCompiled) {
...
function integretyHelper(level, levelType) {
    try {
        ...
        if (currentLevel == undefined) {
            return "Custome error - unexpected error happend - first parameter value is undefined!!!";
        }
...
describe('Testing level data integrety', () => {
    describe('Testing each level if valid to their type', () => {
        describe('Tutorial/introduction levels (level #1-8)', () => {
            ...
            test('level #2', () => {
                const result = integretyHelper(2, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
            test('level #3', () => {
                const result = integretyHelper(3, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
            test('level #4', () => {
                const result = integretyHelper(4, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
            test('level #5', () => {
                const result = integretyHelper(5, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
            test('level #6', () => {
                const result = integretyHelper(6, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
            test('level #7', () => {
                const result = integretyHelper(7, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
            test('level #8', () => {
                const result = integretyHelper(8, LevelType.tutorial);
                console.log(result);
                expect(result).toBe("");
            });
        });
        describe('Correction and partial levels (level #9, #11, #12, #15, #18 and #19)', () => {
            describe('Correction levels (level #9, #12 and #19)', () => {
                test('level #9', () => {
                    const result = integretyHelper(9, LevelType.partial);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #12', () => {
                    const result = integretyHelper(12, LevelType.partial);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #19', () => {
                    const result = integretyHelper(19, LevelType.partial);
                    console.log(result);
                    expect(result).toBe("");
                });
            });
            describe('Partial levels (level #11, #15 and #18)', () => {
                test('level #11', () => {
                    const result = integretyHelper(11, LevelType.partial);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #15', () => {
                    const result = integretyHelper(15, LevelType.partial);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #18', () => {
                    const result = integretyHelper(18, LevelType.partial);
                    console.log(result);
                    expect(result).toBe("");
                });
            });
        ...
        describe('Big formula and contexual levels (level #10, #13, #14, #16, #17, and #20)', () => {
            describe('Big formula levels (level #10 and #20)', () => {
                test('level #10', () => {
                    const result = integretyHelper(10, LevelType.contextual);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #20', () => {
                    const result = integretyHelper(20, LevelType.contextual);
                    console.log(result);
                    expect(result).toBe("");
                });
            });
            describe('Contextual levels (level #13, #14, #16, and #17)', () => {
                test('level #13', () => {
                    const result = integretyHelper(13, LevelType.contextual);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #14', () => {
                    const result = integretyHelper(14, LevelType.contextual);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #16', () => {
                    const result = integretyHelper(16, LevelType.contextual);
                    console.log(result);
                    expect(result).toBe("");
                });
                test('level #17', () => {
                    const result = integretyHelper(17, LevelType.contextual);
                    console.log(result);
                    expect(result).toBe("");
                });
            });
    ...
    describe('Testing levels as inncorrect types', () => {
        describe('Tutorial/introduction - level #1', () => {
            test('as partial', () => {
                const result = integretyHelper(1, LevelType.partial);
                console.log(result);
                expect(result).not.toBe("");
            });
            test('as contextual', () => {
                const result = integretyHelper(1, LevelType.contextual);
                console.log(result);
                expect(result).not.toBe("");
            });
        });
        describe('partial - level #9', () => {
            test('as tutorial/introduction', () => {
                const result = integretyHelper(9, LevelType.tutorial);
                console.log(result);
                expect(result).not.toBe("");
            });
            test('as contextual', () => {
                const result = integretyHelper(9, LevelType.contextual);
                console.log(result);
                expect(result).not.toBe("");
            });
        });
        describe('contexual - level #10', () => {
            test('as partial', () => {
                const result = integretyHelper(10, LevelType.partial);
                console.log(result);
                expect(result).not.toBe("");
            });
            test('as tutorial/introduction', () => {
...
describe('Testing level checking', () => {
    describe('Successful checks testing', () => {
        describe('Levels #9-10', () => {
            test('Level 9', async () => {
                const result = await checkerHelper3Star(9);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 10', async () => {
                const result = await checkerHelper3Star(10);
                console.log(result);
                expect(result).toEqual("");
            });
        });
        describe('Levels #11-20', () => {
            test('Level 11', async () => {
                const result = await checkerHelper3Star(11);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 12', async () => {
                const result = await checkerHelper3Star(12);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 13', async () => {
                const result = await checkerHelper3Star(13);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 14', async () => {
                const result = await checkerHelper3Star(14);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 15', async () => {
                const result = await checkerHelper3Star(15);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 16', async () => {
                const result = await checkerHelper3Star(16);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 17', async () => {
                const result = await checkerHelper3Star(17);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 18', async () => {
                const result = await checkerHelper3Star(18);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 19', async () => {
                const result = await checkerHelper3Star(19);
                console.log(result);
                expect(result).toEqual("");
            });
            test('Level 20', async () => {
                const result = await checkerHelper3Star(20);
                console.log(result);
                expect(result).toEqual("");
            });
        });
    ...
    describe('More detailed check testing', () => {
        describe('Unsuccessful check testing', () => {
            ...
            test('incorrect star count', async () => {
                ...
                const stars = await checkerHelperCustom(9, [901, 312, 901, 313, 212, 809, 512, 902, 611, 513, 902, 0, 0, 0]);
        ...
        describe('Successful check testing', () => {
            ...
            test('2-star message - lower limit', async () => {
                const stars = await checkerHelperCustom(9, [901, 312, 901, 313, 212, 809, 512, 902, 611, 513, 902, 0, 0, 0, 0]);
            ...
            test('2-star message - higher limit', async () => {
                const stars = await checkerHelperCustom(9, [901, 312, 901, 313, 212, 809, 512, 902, 611, 513, 902, 0, 0, 0, 0, 0, 0, 0, 0]);
            ...
            test('1-star message', async () => {
                const stars = await checkerHelperCustom(9, [901, 312, 901, 313, 212, 809, 512, 902, 611, 513, 902, 0, 0, 0, 0, 0, 0, 0, 0, 0]);
