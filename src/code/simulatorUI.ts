...
export class SimulatorUI{
    ...
    private addRowIfNeeded(textbox:HTMLInputElement):void{ this.editorUI.generateLine(textbox); }
    private navigateEditor(event:KeyboardEvent):void{ this.editorUI.navigationCheck(event); }
