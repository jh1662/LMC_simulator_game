...
export class ControlUnit{
    ...
    public async cycle():Promise<string[]>{ //< emulator cycle
        ...
        while (true){
            ...
            cycleCount++;
            if (cycleCount >= this.cycleCountLimit){ this.displayStatus(UICatagory.status,["User has manually stopped the LMC assembly program or it has reached the timeout limit (300 cycles)."]); break; }
